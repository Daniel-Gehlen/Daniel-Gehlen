...
```markdown
  ...
  <div style="background-color: #3498db; color: white; padding: 10px; border-radius: 8px;">
      <p>Esta é uma caixa azul estilizada usando GFM.</p>
  </div>

  <div style="background-color: #2ecc71; color: white; padding: 10px; border-radius: 8px;">
